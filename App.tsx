...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-transparent text-white font-sans p-0 sm:p-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-gray-700 border border-gray-600 rounded-md text-sm text-gray-300 hover:bg-gray-600 transition-colors"
              >
                <HistoryIcon className="w-5 h-5" />
                <span className="hidden sm:inline">Sessions</span>
              </button>
              {isSessionMenuOpen && (
                <div className="absolute right-0 mt-2 w-64 sm:w-72 bg-gray-800 border border-gray-700 rounded-md shadow-lg z-10">
                  <div className="p-2">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-gray-700 border border-gray-600 rounded-md text-sm text-gray-300 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
